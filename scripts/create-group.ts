...
client.on('cspReady', async () => {
    ...
    try {
        const members = ['58DHN95R', 'BABNPZ5Y'];
        const groupName = 'Stephan, Stephan USA & Assistent';
        ...
        await client.sendGroupTextMessage(
            ...
            result.groupId, 
            result.members, 
            "Hallo zusammen! Ich habe nochmals eine neue Gruppe erstellt, diesmal mit dem korrekten Namen. Bitte entschuldigt die Verwirrung vorher."
        );
